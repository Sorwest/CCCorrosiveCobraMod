...
namespace CorrosiveCobra
{
    public partial class Manifest
    {
        ...
        {
            {
                EvolveStatus = new ExternalStatus("CorrosiveCobra.Status.EvolveStatus", true, CorrosiveCobraColor, null, EvolveStatusSprite ?? throw new Exception("MissingSprite"), true);
            ...
            {
                HeatOutbreakStatus = new ExternalStatus("CorrosiveCobra.Status.HeatOutbreakStatus", true, CorrosiveCobraColor, null, HeatOutbreakStatusSprite ?? throw new Exception("MissingSprite"), true);
            ...
            {
                HeatControlStatus = new ExternalStatus("CorrosiveCobra.Status.HeatControlStatus", true, CorrosiveCobraColor, null, HeatControlStatusSprite ?? throw new Exception("MissingSprite"), true);
