...
namespace CorrosiveCobra
{
    public partial class Manifest
    {
        ...
        {
            HarmonyPatchLogic(new Harmony("Sorwest.CorrosiveCobra.harmony"));
        ...
        private void HarmonyPatchLogic(Harmony harmony)
        {
            MethodInfo method1 = typeof(Card).GetMethod("OnDraw");
            MethodInfo method2 = typeof(Manifest).GetMethod("EvolveOnDraw", System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.NonPublic);
            harmony.Patch(method1, postfix: new HarmonyMethod(method2));
            MethodInfo method3 = typeof(Ship).GetMethod("OnAfterTurn");
            MethodInfo method4 = typeof(Manifest).GetMethod("TurnEnd", System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.NonPublic);
        ...
        private static void EvolveOnDraw(State s, Combat c)
        {
            ...
            if (index < 0)
                return;
            if (c.hand[index].GetMeta().deck == Deck.trash || c.hand[index].GetMeta().deck == Deck.corrupted)
            {
