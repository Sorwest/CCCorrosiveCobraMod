    ...
    IAnimationManifest
{
    ...
    {
        {
            CorrosiveCobra_Character = new ExternalCharacter("Sorwest.CorrosiveCobra.Character.DizzySlime",
    ...
    {
        {
            CorrosiveCobra_Character_DefaultAnimation = new ExternalAnimation("Sorwest.CorrosiveCobra.Animation.CorrosiveCobra_Character_DefaultAnimation",
                CobraDeck ?? throw new Exception("missing deck"),
                "default", false,
        ...
        {
            CorrosiveCobra_Character_MiniAnimation = new ExternalAnimation("Sorwest.CorrosiveCobra.Animation.CorrosiveCobra_Character_MiniAnimation",
                CobraDeck ?? throw new Exception("missing deck"),
                "mini", false,
        ...
        {
            CorrosiveCobra_Character_GameoverAnimation = new ExternalAnimation("Sorwest.CorrosiveCobra.Animation.CorrosiveCobra_Character_GameoverAnimation",
            CobraDeck ?? throw new Exception("missing deck"),
            "gameover", false,
        ...
        {
            CorrosiveCobra_Character_TalkSquintAnimation = new ExternalAnimation("Sorwest.CorrosiveCobra.Animation.CorrosiveCobra_Character_TalkSquintAnimation",
                CobraDeck,
                "squint",
                false,
                TalkSquintSprites);
        ...
        {
            CorrosiveCobra_Character_TalkLaughAnimation = new ExternalAnimation("Sorwest.CorrosiveCobra.Animation.CorrosiveCobra_Character_TalkTalkLaughAnimation",
                CobraDeck,
                "laugh",
                false,
                TalkLaughSprites);
        ...
        {
            CorrosiveCobra_Character_TalkNeutralAnimation = new ExternalAnimation("Sorwest.CorrosiveCobra.Animation.CorrosiveCobra_Character_TalkNeutralAnimation",
                CobraDeck,
                "neutral",
                false,
                TalkNeutralSprites);
        ...
        {
            CorrosiveCobra_Character_TalkSadAnimation = new ExternalAnimation("Sorwest.CorrosiveCobra.Animation.CorrosiveCobra_Character_TalkSadAnimation",
                CobraDeck,
                "sad",
                false,
                TalkSadSprites);
        ...
        {
            CorrosiveCobra_Character_TalkMadAnimation = new ExternalAnimation("Sorwest.CorrosiveCobra.Animation.CorrosiveCobra_Character_TalkMadAnimation",
                CobraDeck,
                "mad",
                false,
                TalkMadSprites);
        ...
        {
            CorrosiveCobra_Character_TalkDarkAnimation = new ExternalAnimation("Sorwest.CorrosiveCobra.Animation.CorrosiveCobra_Character_TalkDarkAnimation",
                CobraDeck,
                "dark",
                false,
                TalkDarkSprites);
        ...
        {
            CorrosiveCobra_Character_TalkPhoneAnimation = new ExternalAnimation("Sorwest.CorrosiveCobra.Animation.CorrosiveCobra_Character_TalkPhoneAnimation",
                CobraDeck,
                "phone",
                false,
                TalkPhoneSprites);
        ...
        {
            CorrosiveCobra_Character_TalkNervousAnimation = new ExternalAnimation("Sorwest.CorrosiveCobra.Animation.CorrosiveCobra_Character_TalkNervousAnimation",
                CobraDeck,
                "nervous",
                false,
                TalkNervousSprites);
